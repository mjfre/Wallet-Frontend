...
class SubstituteSubcomponentTemplate extends Component {

    render() {

        const { tableData, tableStructure, tableRowKey, emptyTableMessage, pageTitle, subcomponentMaintenanceView } = this.props;
...
export default SubstituteSubcomponentTemplate;