...
import PasswordResetRequestView from './PasswordResetRequestView'
...
import background2 from "./../img/guglieri-speciale.jpg";


const LeagueAdminFrontendApp = () => {
    ...
    return (
        <div style={{
            ...
            backgroundImage: 'linear-gradient(to right top, #051937, #562b5d, #aa3961, #e36545, #ebac12)',
            ...
            <BrowserRouter>
                <>
                    <Switch>
                        <Route path="/passwordReset/:passwordResetToken/" component={PasswordResetView}/>
                        <Route path="/assessment/:testToken/" component={AssessmentTestView}/>
                        <Route path="/requestPasswordReset" component={PasswordResetRequestView}/>
                        <Redirect exact from="/index.html" to="/home"/>
                        <AuthenticatedRoute path="/home" exact component={AdminView}/>
...
export default LeagueAdminFrontendApp
